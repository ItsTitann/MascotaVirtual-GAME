...
![Sala Principal](app/src/main/res/drawable/pantalla_sala.png)

### 2. Baño (Higiene)
Mantén a Patroclo reluciente usando la regadera y el jabón.
![Baño](app/src/main/res/drawable/pantalla_bano.png)

### 3. Dormitorio (Descanso)
Apaga las luces para que Patroclo pueda recuperar energías.
![Dormitorio](app/src/main/res/drawable/background_night.png)

### 4. Sala de Diversión y Minijuegos
El lugar ideal para jugar y entretenerse.
![Diversión](app/src/main/res/drawable/pantalla_diversion.png)
![Minijuego de Pesca](app/src/main/res/drawable/pantalla_juego_pesca.png)
